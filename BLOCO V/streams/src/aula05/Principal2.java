...
public class Principal2 {
    public static void main(String[] args) {
        ...
        var pessoas = List.of(
                new CorrecaoAula04.PessoaExercicio("joao", 15),
                new CorrecaoAula04.PessoaExercicio("maria", 40),
                new CorrecaoAula04.PessoaExercicio("carlos", 34),
                new CorrecaoAula04.PessoaExercicio("icaro", 25));

        DoubleStream doubleStream = pessoas.stream()
                .mapToDouble(CorrecaoAula04.PessoaExercicio::idade);
        ...
        List<CorrecaoAula04.PessoaExercicio> pessoaExercicios = idadesIntStream.mapToObj(Principal2::buscarPorIdade)
                .toList();
    ...
    private static CorrecaoAula04.PessoaExercicio buscarPorIdade(int idade) {
        return List.of(new CorrecaoAula04.PessoaExercicio("joao", 15),
                        new CorrecaoAula04.PessoaExercicio("maria", 40),
                        new CorrecaoAula04.PessoaExercicio("carlos", 34),
                        new CorrecaoAula04.PessoaExercicio("icaro", 25))
                .stream()
